...
namespace NLayer.API.Controllers
{
    ...
    public class ProductsController : CustomBaseController
    {
        ...
        {
            var product = await _service.AddAsync(_mapper.Map<Product>(productDto)); //Product'ı productDto'a dönüştürdüm.
        ...
        {
            await _service.UpdateAsync(_mapper.Map<Product>(productDto)); //Product'ı productDto'a dönüştürdüm.
            return CreateActionResult(CustomResponseDto<NoContentDto>.Success(204)); //201 Created
